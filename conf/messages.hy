...
landing.header.body=Մենք հետազոտում ենք մարդկանց հաղորդակցությունը սոցհարթակներում
landing.what.title=Ուսումնասիրության մասին
landing.what.body1=Սոցիալական շփումները կարևոր դեր ունեն մարդկանց կյանքում։ Մեր խումբը մշակում է թվային գործիքներ այդ դերն ավելի լավ հասկանալու համար։
landing.what.body2=Մասնակցության համար կարող եք Ձեր անանուն տվյալները նվիրաբերել Facebook կամ Instagram հարթակներից։
landing.why.title=Ինչո՞ւ մասնակցել
landing.why.col1.title=Ստացեք Ձեր հաղորդակցությունը նկարագրող գրաֆիկներ
landing.why.col1.body=Որպես շնորհակալություն կտրամադրենք Ձեր օնլայն շփումների վերլուծության գրաֆիկները, օրինակ՝ քանի հաղորդագրություն եք ստացել ու ուղարկել վերջին ամիսներին։ Այս ուսումնասիրությունը կլինիկական կամ հոգեբանական ախտորոշում չի ենթադրում։
landing.why.col2.title=Աջակցեք գիտությանը
landing.why.col2.body_html=Ուսումնասիրությունը կօգնի ավելի լավ հասկանալ, թե ինչպես են մարդիկ հաղորդակցվում։
landing.why.col3.title=Մնացեք անանուն
landing.why.col3.body_html=Մենք ընդունում ու վերլուծում ենք <strong><a href="/learn-more">բացառապես անանուն տվյալներ </a></strong>, ինչպես օրինակ  հաղորդագրության բառերի քանակ, ժամանակը։  Տեքստ, նկարներ, ֆայլեր, մասնակիցների անուններ կամ համարներ չեն գրանցվում։ Հավաստիացնում ենք, որ հասանելիություն չունենք Ձեր հաղորդագրությունների  ու գրառումների բովանդակությանը։
...
landing.imagePath.donationProcedure1=images/landingDonationProcedure_1_Armenian.png
...
# Learn More page
learn-more.how-to-participate.title=Մասնակցության ընթացակարգը
learn-more.how-to-participate.body=Մասնակցության համար խնդրում ենք պատասխանել մի քանի հարցի և նվիրաբերել Ձեր անանուն տվյալները։ Տվյալները ներբեռնելուց հետո, մասնակցությունը Ձեզնից կխլի ընդամենը 10 րոպե։
learn-more.how-to-cancel.title=Կամավոր մասնակցություն
learn-more.how-to-cancel.body=Մասնակցությունը միանգամայն կամավոր է։ Այն ամեն պահի կարող եք դադարեցնել՝ առանց ինչ-որ պատճառ նշելու կամ բացասական հետևանքների։ Համաձայնությունը կարող եք չեղարկել մինչև տվյալները մեզ ուղարկելը։
...
learn-more.imagePath.overview=images/dataOverview-Armenian.png
learn-more.storage.body1_html=<strong><em>Տվյալների նվիրաբերում - </strong></em> Մենք ստանում ենք միայն մետա-տվյալներ (հաղորդագրությունների, գրառումների երկարությունն ու ժամանակը, թվեր՝ հաղորդագրության մասնակիցների անունների փոխարեն), չենք ստանում հաղորդակցությունների  բովանդակությունը (տեքստ, ֆայլեր կամ մասնակիցների անունները)։ Անձնական տվյալները չեն լքում Ձեր սարքը, քանի որ տվյալների մշակումը կատարվում է տեղում՝ Ձեր բրաուզերում։ Հետևաբար մենք չենք տեսնում տեքստերի կամ ֆայլերի բովանդակությունը։ Վերբեռնելուց առաջ կարող եք տեսնել, թե ինչ տվյալներ եք մեզ ուղարկում՝ համոզվելով, որ դրանք անանուն են։
learn-more.storage.body2_html=<strong><em>Հարցաշար: </strong></em>մասնակցությունը սկսելիս անհրաժեշտ է մի քանի հարցի պատասխանել։ Այնուհետև կարող եք նվիրաբերել Ձեր տվյալներն ու ստանալ գրաֆիկներ։ Հարցաշարերից ստացված տվյալները ևս բոլորովին անանուն են և հավաքվում են <a target="_blank" href="https://www.limesurvey.org/support/faq/39-data-protection-and-policy">LimeSurvey</a> հարթակի օգնությամբ.
...
learn-more.image.data-overview.caption=Նվիրաբերվող տվյալների ցանկ
# Instructions page
instructions.about.title=Ինչպե՞ս կարող եմ ներբեռնել տվյալներս
instructions.about.body_html=Մասնակցելուց առաջ խնդրում ենք ներբեռնել Ձեր տվյալները Facebook և/կամ Instagram հարթակներից։ Կարող եք տվյալներ նվիրաբերել միաժամանակ երկու հարթակից։ Եթե ընտրում եք հարթակներից միայն մեկը, խնդրում ենք ընտրել այն հարթակը, որն ավելի կարևոր է Ձեզ համար։ <b>Խնդրում ենք ուշադիր կարդալ ստորև տրամադրված հրահանգները, քանի որ դրանք կարևոր են հաջորդ քայլերի համար</b>։
...
instructions.continue.body=Ձեր տվյալները ներբեռնելուց հետո, հաջորդ քայլով կարող եք տալ Ձեր համաձայնությունն ու սկսել մասնակցությունը։ Այնուհետև կարող եք տվյալները վերբեռնել, անանուն դարձնել ու նվիրաբերել։
instructions.haveData=Ստացե՞լ եք Ձեր տվյալները
# Donation Info page
donation-info.title=Տվյալների տրամադրման կարգը
donation-info.data-request=<strong>Տվյալների ներբեռնում - </strong> Տվյալները կարող եք ներբեռնել Ձեր ընտրած սոցհարթակից (Facebook և/կամ Instagram)։
donation-info.anonymisation=<strong>Ապանույնականացում - </strong> Հաղորդագրությունների, գրառումների ու մեկնաբանությունների բովանդակությունը հեռացվում է, և մեզ միայն մետա-տվյալներ են հասնում։ Անունները փոխարինվում են թվերով, օր.՝ Նարեկ &rarr; անանուն13: Վերբեռնելուց առաջ կարող եք տեսնել, թե ինչ տվյալներ եք մեզ ուղարկում՝ համոզվելով, որ դրանք անանուն են։
...
consent.benefit.body=Ձեր մասնակցությունը մեզ հնարավորություն կտա ավելի լավ հասկանալ ու բնորոշել մարդկանց սոցիալական շփումները։ Դուք էլ կարող եք պատկերացում կազմել Ձեր առցանց հաղորդակցության մասին։  Վերջում կստանաք 5€ փոխհատուցում մասնակցության համար։ Մենք հավաքում ենք միայն ապանույնականացված տվյալներ։ Մինչև տվյալների նվիրաբերումը, անհրաժեշտ է սոցհարթակներից պահանջել տվյալները ու դրանք ներբեռնել Ձեր սարք։ Քանի որ այդ տվյալները պարունակում են Ձեր հաղորդագրություններն ու գրառումները, խորհուրդ ենք տալիս ուսումնասիրության վերջում դրանք ջնջել Ձեր սարքից։ Խնդրում ենք մասնակցել մենակ ու հանգիստ միջավայրում՝ գաղտնիությունը ապահովելու համար։
consent.data-storage.title=Տվյալների հավաքում
consent.voluntary.title=Կամավոր մասնակցություն
consent.voluntary.body=Ձեր մասնակցությունը միանգամայն կամավոր է։ Ամեն պահի կարող եք դադարեցնել մասնակցությունը՝ առանց ինչ-որ պատճառ նշելու կամ բացասական հետևանքների։ Մինչև Ձեր անանուն տվյալները մեզ ուղարկելը կարող եք չեղարկել Ձեր համաձայնությունը՝ առանց բացասական հետևանքների։
consent.data-protection.title=Տվյալների ապահովություն
consent.data-protection.body=Քանի որ անուններ կամ նույնականացնող այլ տվյալներ չենք հավաքում, հնարավոր չէ տվյալները կապել Ձեր անձի հետ․ տվյալների բազան լիովին անանուն է։ Անձնական ոչ մի տվյալ չունենալով՝ չենք կարող ավարտից հետո առանձնացնել ու ջնջել Ձեր տվյալները։ Քանի որ տվյալները ամբողջովին անանուն են, ընդհանուր տվյալների պաշտպանության կանոնակարգը (GDPR) կիրառելի չէ։ Հարցերի կամ մտահոգությունների դեպքում կարող եք կապ հաստատել Բիլեֆելդի համալսարանում տվյալների պաշտպանության հանձնակատարի հետ՝
consent.data-protection.address_html=Տվյալների պաշտպանության հանձնակատար <br /> Բիլեֆելդի համալսարան <br /> Գրասենյակ: UHG T6-234 <br />Հեռ․ +49 521 106-5225 <br /><a href="mailto:datenschutzbeauftragte@uni-bielefeld.de">datenschutzbeauftragte@uni-bielefeld.de</a>
...
donation.select-data.donation=Տվյալների ուղարկում
donation.select-data.input1=Ընտրել ֆայլերը
donation.select-data.input2=Փնտրել
donation.select-data.remove=Հեռացնել
donation.select-date.start=Սկիզբ
donation.select-date.end=Վերջ
donation.preview-data.title=Անանուն տվյալների նախադիտում
donation.preview-data.button=Սեղմեք այստեղ նախադիտման համար
donation.preview-data.body1=Ոչ մի անձնական տվյալ Ձեր սարքից դուրս չի եկել։ Միայն մետա-տվյալներ են առանձնացվել։
donation.preview-data.body2=Ինչպես տեսնում եք, բոլոր օգտանունները հեռացվել են, հաղորդագրության տեքստը փոխարինվել է բառերի քանակով։
donation.preview-data.message=Հաղորդագրություն
donation.preview-data.sender=Ուղարկող
donation.preview-data.receiver=Ստացող
donation.preview-data.word-count=Բառերի քանակ
donation.preview-data.length-seconds=Տևողությունը՝ ըստ վայրկյանների
donation.preview-data.timestamp=Ժամանակ
donation.preview-data.group-conversation=Խմբային հաղորդագրություն
donation.preview-data.voice-message=Ձայնային հաղորդագրություն
donation.friendsMapping.title=<b>Ձեր չատերի ծածկանունները</b>
donation.friendsMapping.subtitle.facebook=Ձեր տվյալներն ու կոնտակտներն այժմ ապանույնականացված են, բովանդակությունը հեռացված։ Եթե գրաֆիկները ուսումնասիրելիս ինքներդ ցանկանում եք վերծանել, թե որ չատերն են ներառված, խնդրում ենք գրի առնել, թե որ համարն է (օր․՝ “F4") համապատասխանում յուրաքանչյուր չատին (օր․ ՝ A**** B*****) ։ Այսուհետ, միայն այս համարներն են երևալու։ Կոնտակտների ու համարների համապատասխանությունը չի պահպանվում և կորչում է այս էջը լքելուց հետո։
...
donation.friendsMapping.subtitle.instagram=Ձեր տվյալներն ու կոնտակտներն այժմ ապանույնականացված են, բովանդակությունը հեռացված։ Եթե գրաֆիկները ուսումնասիրելիս ինքներդ ցանկանում եք վերծանել, թե որ չատերն են ներառված, խնդրում ենք գրի առնել, թե որ համարն է (օր․՝ “I4") համապատասխանում յուրաքանչյուր կոնտակտին (օր․ ՝ A**** B*****) ։ Այսուհետ միայն այս համարներն են երևալու։ Կոնտակների ու համարների համապատասխանությունը չի պահպանվում և կորչում է այս էջը լքելուց հետո։
donation.friendsMapping.onlySeven=Սրանք ամենաշատ բառեր պարունակող Ձեր 7 չատերն են Ֆեյսբուքում։ <b>Ներքևում կարող եք այլ չատեր ընտրել։</b>
donation.friendsMapping.moreFriends=ևս {0} կոնտակտ.
donation.friendsMapping.chat=Չատ
...
donation.choose-files-here=Ընտրեք, թե որ ֆայլերից եք ցանկանում տրամադրել Ձեր տվյալները
donation.choose-period=Ստորև կարող եք սահմանափակել տրամադրվող տվյալների ժամանակահատվածը
donation.aliases-overview=Ձեր չատերի ծածկանունները
...
donation.anonymisation.loading.tooLong.issue.1=փորձում եք վերբեռնել չթույլատրված ֆորմատի ֆայլեր։ Ճիշտ ֆորմատը՝ .zip
...
donation.errors.no-profile=Վերբեռնված տվյալները չեն պարունակում պրոֆիլի մասին ինֆորմացիա
donation.errors.no-alias=Խնդրում ենք մուտքագրել Ձեր օգտանունը։ Այն կարող եք գտնել WhatsApp-ի Ձեր պրոֆիլում։
donation.errors.not-enough-chats_format=Խնդրում ենք ընտրել 5-7 ամենակարևոր չատերը։ Դուք ընտրել եք %s-ը։
donation.errors.something-went-wrong=Ցավում ենք, ինչ-որ խնդիր է առաջացել, խնդրում ենք նորից սկսել։
donation.errors.same-file=Կարող եք ընտրել միայն չկրկնվող ֆայլեր։ Խնդրում ենք ընտրել Ձեր 5-7 ամենակարևոր չատերը։
donation.errors.no-messages-time-period=Տվյալ ժամանակահատվածում հաղորդագրություններ չկան։ Խնդրում ենք ընտրել ավելի երկար ու վավեր ժամանակահատված։
...
donation.errors.emptyOrJustOnePerson=Յուրաքանչյուր չատ պետք է առնվազն մեկ զրուցակից (բացի Ձեզնից) և մինիմում 100 տեքստային հաղորդագրություն պարունակի։
...
feedback.reminder=Մի մոռացեք վերջում գրանցվել փոխհատուցման համար՝ սեղմելով էջի ներքևում գտնվող կոճակը։
...
feedback.graph.time=Ժամանակ
feedback.graph.number-of-messages=Հաղորդագրությունների քանակ
feedback.graph.sent=Ուղարկած
feedback.graph.received=Ստացած
feedback.graph.response-times=%s պատասխանի արագություն
feedback.graph.response-time=Պատասխանի արագություն
feedback.graph.median-response-time=Պատասխանի արագության միջինը (մեդիան) արժեքը
feedback.graph.overview=Ընդհանուր պատկեր
...
feedback.toRaffleButton=Գրանցվել փոխհատուցման համար
...
feedback.graph.slidingWindowMean.legend.receivedNotShown=Տվյալների գաղտնություն․ ստացված բառերի քանակը չի ցուցադրվում
...
feedback.graph.dailyActivityHoursPlot.average=Ձեր միջինը
...
feedback.graph.dayPartsOverall.yAxis=Բառերի տոկոս
...
feedback.graph.responseTimeBarChart.yAxis=Պատասխանների տոկոսը
...
data-protection.title=Գաղտնիության քաղաքականություն
...
data-storage.body1_html=<strong><em>Տվյալների նվիրաբերում - </strong></em> Մենք ստանում ենք միայն մետա-տվյալներ (հաղորդագրությունների, գրառումների երկարությունն ու ժամանակը, թվեր՝ հաղորդագրության մասնակիցների անունների փոխարեն), չենք ստանում հաղորդակցությունների բովանդակությունը (տեքստ, ֆայլեր կամ մասնակիցների անունները)։ Անձնական տվյալները չեն լքում Ձեր սարքը, քանի որ տվյալների մշակումը կատարվում է տեղում՝ Ձեր բրաուզերում։ Հետևաբար մենք չենք տեսնում տեքստերի կամ ֆայլերի բովանդակությունը։ Վերբեռնելուց առաջ կարող եք տեսնել, թե ինչ տվյալներ եք մեզ ուղարկում՝ համոզվելով, որ դրանք անանուն են։
data-storage.body2_html=<strong><em>Հարցաշար -  </strong></em>մասնակցությունը սկսելիս անհրաժեշտ է մի քանի հարցի պատասխանել։ Այնուհետև կարող եք նվիրաբերել Ձեր տվյալներն ու ստանալ գրաֆիկներ։ Հարցաշարերից ստացված տվյալները ևս բոլորովին անանուն են և հավաքվում են <a target="_blank" href="https://www.limesurvey.org/support/faq/39-data-protection-and-policy">LimeSurvey</a> հարթակի օգնությամբ։
...
links.imprint=Իրավական ծանուցում
...
facebook.donation-procedure.2=Վերին ձախ մասում սեղմեք Ձեր նկարի վրա և ընտրեք «Կարգավորումներ և գաղտնիություն» տարբերակը, ապա՝ «Կարգավորումներ»։
facebook.donation-procedure.3=Ձախ կողմում սեղմեք «Հաշիվների կենտրոն»/ "Accounts center" /"Центр аккаунтов" հատվածի վրա։
facebook.donation-procedure.4=Ընտրեք «Ձեր տեղեկությունները և թույլտվությունները»/ "Your information and permissions"/"Ваша информация и разрешения" տարբերակը, ապա՝ «Ներբեռնեք Ձեր վերաբերյալ տեղեկությունները»/"Download your information"/"Скачивание вашей информации։
facebook.donation-procedure.5=Սեղմեք «Ներբեռնել կամ փոխանցել տեղեկություններ»/“Download or transfer information”/ "Скачать или перенести информацию" կոճակը։ Ընտրեք Ձեր հիմնական պրոֆիլը, այլ պրոֆիլների առկայության դեպքում հեռացրեք կապույտ նշանը։
facebook.donation-procedure.6=Այս բաժնում պետք է նշեք, թե որ տեղեկություններն եք ցանկանում ներբեռնել, ընտրեք «Հասանելի տեղեկություններ»/"All available information"/"Вся доступная информация" տարբերակը։
facebook.donation-procedure.7=Հաջորդ քայլով ընտրեք «Ներբեռնեք սարքում»/"Download to device"/"Скачать на устройство"  տարբերակը։
facebook.donation-procedure.8=Այնուհետև նշեք ամսաթվերի միջակայքը։ Հետաքրքիր գրաֆիկներ տեսնելու և հետազոտության համար արժեքավոր երկարաժամկետ տվյալներ տրամադրելու համար խնդրում ենք ընտրել <b>վեց ամիս</b> տարբերակը, սակայն կարող եք նաև ավելի կարճ ժամանակ ընտրել։
facebook.donation-procedure.9=Ձևաչափ հատվածում ընտրեք JSON տարբերակը։ Մեդիայի որակի համար ընտրեք «Ցածր»/"Low"/"Низкое" տարբերակը։ Սեղմեք «Ստեղծել ֆայլեր»/"Create files"/" "Создать файлы" կոճակը։
facebook.donation-procedure.10=Երբ տվյալները պատրաստ լինեն, կստանաք ծանուցում։ Այս գործընթացը կարող է ժամեր կամ մեկ օրից ավել տևել։
facebook.donation-procedure.11=Ծանուցումը ստանալուց հետո կրկնեք 1-4 քայլերը և սեղմեք «Հասանելի ներբեռնումներ»/ Available downloads"/"Доступные файлы" կոճակը։ Այժմ կարող եք այստեղից ներբեռնել տրամադրված ֆայլերը։
facebook.instruction.gif=facebook_hy.mov
...
instagram.donation-procedure.2=Ձեր պրոֆիլում սեղմեք մենյուի երեք գծերի վրա, ապա ընտրեք "Ваши действия/Your activity"։
...
instagram.donation-procedure.5=Ընտրեք "Вся доступная информация/ All available information" տարբերակը։
instagram.donation-procedure.6=Սեղմեք "Скачать на устройство/Download to device" , ապա "Далее/Next " կոճակը։
instagram.donation-procedure.7=Այնուհետև նշեք ամսաթվերի միջակայքը ("диапазон/date range")։ Հետաքրքիր գրաֆիկներ տեսնելու և հետազոտության համար արժեքավոր երկարաժամկետ տվյալներ տրամադրելու համար խնդրում ենք ընտրել վեց ամիս տարբերակը, սակայն կարող եք նաև ավելի կարճ ժամանակ ընտրել։
instagram.donation-procedure.8=Ձևաչափ հատվածում ընտրեք JSON տարբերակը։ Մեդիայի որակի համար ընտրեք ցածր տարբերակը։
instagram.donation-procedure.9=Սեղմեք "Создать файлы/Create files" կոճակը. Երբ տվյալները պատրաստ լինեն, կստանաք ծանուցում։ Այս գործընթացը կարող է ժամեր կամ մեկ օրից ավել տևել։
instagram.donation-procedure.10=Ծանուցումը ստանալուց հետո ներբեռնեք Ձեր տվյալները հետևելով 1-3 քայլերին, ապա ընտրեք "Доступные файлы/Available downloads" հրահանգը։
instagram.instruction.gif=instagram_rus.mp4
instagram.logo=i-logo.svg

# Imprint
imprint.title=Իրավական ծանուցում
imprint.imprint=Universität Bielefeld<br>Universitätsstrasse 25<br>D-33615 Bielefeld<p>National (0521) 106-00<br>International ++49 521 106-00</p><p>Telefax national (0521) 106-5844<br>Telefax international +49 521 106-5844</p><p>Prefix for the University: 0521-106-...</p><p>E-Mail: post@uni-bielefeld.de<br>Internet: <a href="https://www.uni-bielefeld.de" target="_blank">www.uni-bielefeld.de</a><p>Bielefeld University is a state-supported institution bound to public law. It is officially represented by the rector, Prof. Dr. Angelika Epple.</p>
imprint.rsa.title=Responsible supervisory authorities
imprint.rsa.body=Ministry of Culture and Science in North Rhine-Westphalia<br>Völklinger Straße 49<br>40221 Düsseldorf<p><strong>Value Added Tax identification number</strong><br>Pursuant to § 27 a, VAT ID: DE811307718 - according to paragraph 27 a - Finanzamt (tax office) Bielefeld Innenstadt</p>
imprint.responsibleDona.title=Responsibility for Content of the Donation Platform Dona
imprint.responsibleDona.body=Prof. Dr. Hanna Drimalla<br>Leiterin der AG "Multimodal Behavior Processing"<br>E-mail: drimalla@techfak.uni-bielefeld.de<br><a href="https://www.uni-bielefeld.de/fakultaeten/technische-fakultaet/arbeitsgruppen/multimodal-behavior-processing/" target="_blank">Homepage</a><br>Telephone: +49 521 106-12043<br>Telephone secretary: +49 521 106-6891<br>Room: CITEC-3.108
imprint.responsibleCentralWebsite.title=Responsibility for Content of the Central Websites
imprint.responsibleCentralWebsite.body=<p>Referat für Kommunikation<br> Ingo Lohuis<br>ingo.lohuis@uni-bielefeld.de</p><p>Responsibility for the content of all other Internet pages (e.g. the faculties, institutes, seminars or administrative offices) lies with the facility or author who produced or published the pages. If you have any questions about these webpages, please contact the individuals or facility/office named on the Internet page.</p><p>There are also various decentralized services on their own servers that do not belong to the domain "www.uni-bielefeld.de". These are all the responsibility of their specific operators.</p><p>URLs beginning with "http://wwwhomes.uni-bielefeld.de" lead to private or personal web pages of members of Bielefeld University. The University has no influence on their contents, and these in no way represent any official publication of Bielefeld University.</p>
imprint.liabilityDisclaimer.title=Liability Disclaimer
imprint.liabilityDisclaimer.body=While Bielefeld University makes every effort to ensure that the contents of its website are correct, up-to-date, and without omissions, it cannot accept liability for the accuracy and quality of its website at any given time.</p><p>The website provides hyperlinks to other external websites. The authors and distributors of these sites are responsible for their content. Bielefeld University is not liable for the content of external websites and has no influence on the content of external links. Despite carefully checking the contents when linking to external websites, the University has no liability for the content of external links. The University distances itself expressly from the content of external websites, nor does it endorse it. Course offers and services from the University are not offered on external websites.</p>
imprint.copyright.title=Copyright
imprint.copyright.body=The copyright and usage rights for texts, graphics, photos, design and source code lie - unless otherwise stated - with Bielefeld University. Permission is needed to distribute, use or pass on copies in digital or printed form. This does not affect "copying" the data on to a personal computer to view pages on a browser.
imprint.photoCredits.title=Photo Credits
imprint.photoCredits.body=All photographs remain - unless otherwise stated - copyright of Bielefeld University.
# Donor ID
donorIdInput.title=Տրամադրեք Ձեր մասնակցության ID-ն
donorIdInput.body=Շարունակելու համար խնդրում ենք տրամադրել Ձեր մասնակցության ID-ն
donorIdInput.nextButton=Շարունակել
donorId.remember=Խնդրում ենք գրի առնել/պահպանել Ձեր մասնակցության ID-ն
donorId.yourid=Ձեր մասնակցության ID-ն
