...
landing.mobileAlert=Խորհուրդ ենք տալիս մասնակցել համակարգչով


landing.header.title=Օգնեք տարածել գիտության լույսը
landing.header.body=Օգտագործելով թվային մեթոդներ՝ մեր գիտական խումբը հետազոտում է մարդկանց հաղորդակցությունը սոցհարթակներում ու դրա հնարավոր ազդեցությունը հոգեվիճակի վրա։ Հետազոտությանը կարող եք աջակցել սոցհարթակներից ներբեռնած Ձեր տվյալներով։ Որպես շնորհակալություն կտրամադրենք Ձեր  հաղորդակցության վերլուծության գրաֆիկները։
landing.what.title=Ուսումնասիրության մասին
landing.what.body1=Սոցիալական շփումները կարևոր ազդեցություն ունեն հոգեկան առողջության վրա։ Բիլեֆելդի համալսարանի մեր խումբը մշակում է թվային գործիքներ այդ դերն ավելի լավ հասկանալու համար։ Այս ուսումնասիրության երկարաժամկետ նպատակը մարդկանց սոցիալական ներգրավվածությունը չափելի դարձնելն է։
landing.what.body2=Մասնակցության համար կարող եք Ձեր հաղորդագրությունները ներբեռնել Facebook կամ  WhatsApp հարթակներից։ Այնուհետև կարող եք մեր կայքում այդ հաղորդագրություններից հեռացնել տեքստը, դրանք անանուն դարձնել ու գիտական նպատակներով նվիրաբերել։ <br><i>Խորհուրդ ենք տալիս մասնակցել համակարգչով</i>


landing.why.title=Ինչու՞ մասնակցել
landing.why.col1.title=Ստացեք Ձեր վարքը նկարագրող գրաֆիկներ
landing.why.col1.body=Որպես շնորհակալություն կտրամադրենք Ձեր օնլայն շփումների վերլուծության գրաֆիկները, օրինակ, թե քանի հաղորդագրություն եք ստացել ու ուղարկել վերջին ամիսներին։ Այս ուսումնասիրությունը  կլինիկական կամ հոգեբանական ախտորոշում չի ենթադրում։


landing.why.col2.title=Աջակցեք գիտությանը
landing.why.col2.body_html=Այս ուսումնասիրության շրջանակներում փորձում ենք չափելի դարձնել մարդկանց սոցիալական ներգրավվածությունը օգտագործելով Facebook կամ  WhatsApp հարթակներից տրամադրված տվյալներ։ Ուսումնասիրության երկարաժամկետ նպատակը պարզելն է, թե ինչ ազդեցություն ունեն սոցիալական շփումները հոգեկան առողջության վրա։
...
learn-more.how-to-participate.body=Մասնակցության համար խնդրում ենք պատասխանել մի քանի հարցի և նվիրաբերել Ձեր անանուն տվյալները։ Հաղորդագրությունները ներբեռնելուց հետո, մասնակցությունը Ձեզնից կխլի ընդամենը 5 րոպե։
...
donation-info.data-request=<strong>Տվյալների ներբեռնում - </strong> Տվյալները կարող եք ներբեռնել Ձեր ընտրած սոցհարթակից  (Facebook և/կամ WhatsApp)։
...
donation.select-data.body2=Տվյալները մեզ տրամադրելուց առաջ կարող եք տեսնել, թե ինչ ինֆորմացիա է մեզ հասնելու։ Կարող եք համոզվել, որ Ձեր օգտանունը փոխարինվել է Նվիրատու բառով, իսկ Ձեր կոնտակտների անունները՝ ծածկանուններով։ Բացի դրանից կտեսնեք, որ հաղորդագրության տեքստի փոխարեն մեզ է հասնում միայն բառերի քանակը։
...
donation.friendsMapping.moreFriends=others.
...
donation.aliases-overview=Ձեր կոնտակտների ծածկանունները
...
feedback.reminder=Մի մոռացեք գրանցվել վիճակահանությանը՝ սեղմելով էջի ներքևում գտնվող կոճակը։
...
feedback.facebook.info=Facebook-ում կոնտակտների հնարավոր մեծ թվի պատճառով գրաֆիկները սահմանափակվում են ամենաշատ բառերը պարունակող մինչև 7 չատով։
...
feedback.graph.example.title=Սա <b>օրինակ</b> է, որը <u>հիմնված չէ Ձեր տվյալների վրա</u>.
...
feedback.graph.slidingWindowMean.legend.receivedNotShown=Տվյալների գաղտնիություն․ ստացված բառերի քանակը չի ցուցադրվում
...
whatsapp.instructions.p1.body=Խորհուրդ ենք տալիս մասնակցել համակարգչով, սակայն տվյալների ներբեռնումը WhatsApp-ից պետք է կատարել հեռախոսով։ Ուշադրություն դարձրեք, որ օգտագործեք այնպիսի սարքեր, որոնց ուրիշները հասանելիություն չունեն։
...
whatsapp.donation-procedure.6=Ընտրեք, թե որտեղ եք ցանկանում պահպանել ֆայլերը։ Կարող եք Ձեր անձնական էլ․հասցեով ինքներդ Ձեզ կամ Bluetooth-ի միջոցով Ձեր համակարգչին ուղարկել։
...
facebook.donation-procedure.2=Վերին ձախ մասում սեղմեք Ձեր նկարի վրա և ընտրեք «Կարգավորումներ» տարբերակը։
facebook.donation-procedure.3=Ձախ կողմում սեղմեք «Գաղտնիություն» տարբերակի վրա, ապա՝ «Ձեր Facebook-ի տեղեկությունները»։
facebook.donation-procedure.4=«Ձեր Facebook-ի տեղեկությունները» հատվածում ընտրեք «Ներբեռնել անձնական էջի տեղեկություններ» տարբերակը, ապա սեղմեք «Պահանջեք ներբեռնում» կոճակը։ Ընտրեք Ձեր հիմնական պրոֆիլը և այլ պրոֆիլների առկայության դեպքում հեռացրեք կապույտ նշանը։
facebook.donation-procedure.5=Հաջորդ քայլի ժամանակ սեղմեք երկրորդ տարբերակի վրա՝ «Ընտրել տեղեկությունների տեսակները»։ Նշեք բացառապես «Հաղորդագրություններ» և «Պրոֆիլի տեղեկություններ» տարբերակները։
facebook.donation-procedure.6=Այնուհետև նշեք օրերի միջակայքը։ Հետաքրքիր գրաֆիկներ տեսնելու և հետազոտության համար արժեքավոր երկարաժամկետ տվյալներ տրամադրելու համար խնդրում ենք ընտրել 2-3 տարի, սակայն կարող եք նաև ավելի կարճ ժամանակ ընտրել։
facebook.donation-procedure.7=Ձևաչափ հատվածում ընտրեք JSON տարբերակը և սեղմեք ուղարկել հայտ կոճակը։ Երբ տվյալները պատրաստ լինեն, կստանաք ծանուցում։  Այս գործընթացը կարող է ժամեր կամ մեկ օրից ավել տևել։
facebook.donation-procedure.8=Ծանուցումը ստանալուց հետո հետ վերադարձեք «Ձեր Facebook-ի տեղեկությունները» հատված և ներբեռնեք Ձեր տվյալները։
facebook.donation-procedure.9=
facebook.donation-procedure.10=
facebook.instruction.gif=
