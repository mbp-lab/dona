...
landing.what.body1=Սոցիալական շփումները կարևոր ազդեցություն ունեն հոգեկան առողջության վրա։ Մեր խումբը մշակում է թվային գործիքներ այդ դերն ավելի լավ հասկանալու համար։
landing.what.body2=Մասնակցության համար կարող եք Facebook կամ  WhatsApp հարթակներից Ձեր անանուն տվյալները նվիրաբերել։
...
feedback.reminder=Մի մոռացեք վերջում  վիճակահանությանը գրանցվել՝ սեղմելով էջի ներքևում գտնվող կոճակը։
