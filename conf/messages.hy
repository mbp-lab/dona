...
landing.why.col3.body_html=Մենք ընդունում ու վերլուծում ենք <strong><a href="/learn-more">բացառապես անանուն տվյալներ </a></strong> (հաղորդագրության երկարությունը (բառերի կամ ձայնային հաղորդագրության վայրկյանների քանակը), ժամանակը, թվեր՝ հաղորդագրության մասնակիցների անունների փոխարեն)։ Հաղորդագրության տեքստը, նկարներ, ֆայլեր կամ մասնակիցների անունները չեն գրանցվում։ Հավաստիացնում ենք, որ հասանելիություն չունենք Ձեր հաղորդագրությունների բովանդակությանը։
...
donorIdInput.title=ID-Input
donorIdInput.body=Please enter your ID to continue:
donorIdInput.nextButton=Continue
donorId.remember=Please note your ID:
donorId.yourid=Your ID:
