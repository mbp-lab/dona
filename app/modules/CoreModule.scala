...
final class CoreModule extends AbstractModule {
  override def configure(): Unit = {
    ...
    bind(classOf[GroupPostRepository]).to(classOf[SlickGroupPostRepository])
    bind(classOf[CommentRepository]).to(classOf[SlickCommentRepository])
    bind(classOf[GroupCommentRepository]).to(classOf[SlickGroupCommentRepository])
    bind(classOf[ReactionRepository]).to(classOf[SlickReactionRepository])
